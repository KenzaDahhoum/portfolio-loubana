<template>
    <div class="tabrima-section">
      <div class="image-container">
        <img src="@/assets/images/tabrima.jpeg" alt="Tabrima" />
        <img src="@/assets/images/tabrima-2.jpeg" alt="Tabrima" />
        <img src="@/assets/images/tabrima-3.jpeg" alt="Tabrima" />
      </div>
      <div class="details">
        <h2>{{ product.title }}</h2>
